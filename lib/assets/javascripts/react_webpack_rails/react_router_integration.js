...
function _routerDepricationError(helperName) {
  console.warn(
    RWR._messages.warnings.deprication(helperName, 'Use `RWR.reactRouter.' + helperName + '` instead')
  );
}

function registerRouter() {
  _routerDepricationError('registerRouter');
  RWR.reactRouter.registerRouter.apply(null, arguments);
}

function getRouter() {
  _routerDepricationError('getRouter');
  RWR.reactRouter.getRouter.apply(null, arguments);
}

function renderRouter() {
  _routerDepricationError('renderRouter');
